...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NuJournalPro.Models.Database.BlogImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<byte[]>("CompressedImageData")
                        .HasColumnType("bytea");
            ...
            modelBuilder.Entity("NuJournalPro.Models.Database.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NuJournalPro.Models.Database.BlogImage", b =>
                {
                    b.HasOne("NuJournalPro.Models.Database.Blog", "Blog")
                        .WithOne("BlogImage")
                        .HasForeignKey("NuJournalPro.Models.Database.BlogImage", "BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NuJournalPro.Models.Database.Comment", b =>
                {
                    ...
                    b.HasOne("NuJournalPro.Models.Database.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("NuJournalPro.Models.Database.PageImage", b =>
                {
                    ...
                    b.HasOne("NuJournalPro.Models.Database.Page", "Page")
                        .WithOne("PageImage")
                        .HasForeignKey("NuJournalPro.Models.Database.PageImage", "PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NuJournalPro.Models.Database.PostImage", b =>
                {
                    ...
                    b.HasOne("NuJournalPro.Models.Database.Post", "Post")
                        .WithOne("PostImage")
                        .HasForeignKey("NuJournalPro.Models.Database.PostImage", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
